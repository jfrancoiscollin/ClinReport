# TODO: 
#
# display SD or SE in plots
# complete example
# 
# Author: jfcollin
###############################################################################

#source("C:\\Users\\jfcollin\\Google Drive\\Dev\\ClinReport\\inst\\test.R)
...
gg.mod1=plot(tab.mod1,title="LS-Means response evolution as a function of time\nby treatment group (95% CI)",
 ...
 # Linear model (1 group only): Anova and LS-Means reporting #########################
...
gg.mod2=plot(tab.mod2,title="LS-Means response\nby treatment group (95% CI)",
 ...
 # Linear mixed model (order 2 interaction): Anova and LS-Means reporting #################
...
gg.mod3.contr=plot(tab.mod3.contr,title="LS-Means contrast versus reference A\n
 ...
 # Generalized Logistic Linear model (order 2 interaction): Anova and LS-Means reporting ##########
...
by treatment group (95% CI Logistic model)",
 ...
 # Generalized Poisson Linear model (order 2 interaction): Anova and LS-Means reporting #
