...
#' @param y.levels.label Character. The label to be displayed in the table which indicates the level of \code{y}
#' 
#' @description
...
desc=function(output=NULL,total=NULL,nbcol=NULL,y=NULL,x1=NULL,x2=NULL,
		...
		regrouped=F,rbind.label=NULL,title=NULL,y.levels.label=NULL)
{
	...
	l=list(output=output,total=total,nbcol=nbcol,y=y,x1=x1,x2=x2,
			...
			rbind.label=rbind.label,title=title,y.levels.label=y.levels.label)
