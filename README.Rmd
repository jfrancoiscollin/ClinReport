...
The aim of ClinReport is to create statistical outputs (tables and graphics) in 'Microsoft Word'
according to 'clinical standards' of reporting. 

The formatted outputs are also suitable for any publications, so it can also be used outside the scope of clinical trials.
